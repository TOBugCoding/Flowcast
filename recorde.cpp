...
//        }
//        /* if (packet.stream) {
//             std::cout << "Stream index: " << packet.stream->index
//                 << ", type: " << (packet.stream->codecpar->codec_type == AVMEDIA_TYPE_VIDEO ? "video" : "audio")
//                 << ", time_base: " << packet.stream->time_base.num << "/" << packet.stream->time_base.den << std::endl;
//         }*/
//         // 确保时间戳有效
